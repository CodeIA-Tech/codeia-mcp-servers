#!/usr/bin/env node
/**
 * Atualiza as mensagens dos monitores P3 para usar o template correto
 * Template-DatadogMonitors-Porto-p3p4p5.md
 */
...
/**
 * Lê o template P3P4P5
 */
function loadTemplate() {
  const templatePath = path.join(__dirname, '..', '..', 'assets', 'templates', 'datadog', 'Template-DatadogMonitors-Porto-p3p4p5.md');
...
async function main() {
  console.log('📝 Atualizando mensagens dos monitores P3 para usar o template correto...\n');

  const creds = getCredentials();
  
  // Carrega o template P3P4P5
  console.log('📄 Carregando template Template-DatadogMonitors-Porto-p3p4p5.md...');
  const template = loadTemplate();
  console.log('✅ Template carregado\n');
  
  // IDs dos monitores P3
  const monitorIds = [
